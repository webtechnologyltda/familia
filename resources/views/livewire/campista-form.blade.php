            ...
            <form wire:submit.prevent="compraNovaPassagem" class="md:p-12 mx-4 p-4">
                <section class="bg-transparent text-white min-h-screen flex flex-col justify-center items-center relative">
                    ...
                    <p class="text-white text-center text-2xl mt-8 font-bangers">Valor da Inscrição<br></br>
                        <span class="text-yellow-500 font-bold text-4xl text-center text-md mt-0">R$ 200,00</span>
                    </p>
                    <p class="text-white text-center text-2xl mt-8 font-bangers">POR PESSOA, REALIZAR O PIX COM VALOR TOTAL DA FAIMÍLIA
                    ...
                    <p class="text-center mt-8  text-white xl:text-md ">Obrigatório <br> Enviar o  comprovante para o atendente.  </p>
                    ...
                    <div class="flex justify-evenly mx-6 mt-4 text-center">
                        <div class="justify-items-center">
                            ...
                            <div class="mt-2 grid justify-items-center">
                                <a target="_blank"
                                   href="https://wa.me/55{{str_replace(['(', ')', '-', ' '], '', $this->settings['telefone_atendente'])}}?text=Ol%C3%A1+tenho+uma+d%C3%BAvida+sobre+o+Acampamento+de+familia%2C+consegue+me+ajudar+%3F"
